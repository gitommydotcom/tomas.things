...
/* Viky's body sway is the family-wide one, built into SqCreature
   (see useSway in Doodles.jsx) - the footer only adds her party
   trick: eyes that follow the pink dot around the page. */
export default function Footer() {
  const eyesRef = useRef(null)

  // the eyes only chase the pointer while the footer is actually on
